    ...
    <>
      <Sheet>
        ...
        <SheetContent
          hideCloseButton
          side={"left"}
          className="border-r-0 pt-2 px-0 bg-white "
        >
          <div className="flex items-center self-center justify-between h-[4rem] px-4 border-b">
            ...
            <SheetClose asChild>
              <Button
                title="close"
                size={"icon"}
                className="w-10 h-10 rounded-full bg-transparent hover:bg-gray-100 group duration-300 p-0 "
              >
                ...
                return (
                  <SheetClose key={index} asChild>
                    <a href={link.href}>
                      <Button
                        variant={"ghost"}
                        className={`px-4 py-3 w-full rounded-none justify-start text-black bg-transparent `}
                      >
                        {link.label}
                      </Button>
                    </a>
