    ...
    <>
      <div id="hero" className="w-full mt-12 md:mt-[8rem]">
        ...
        <ContainerWrapper>
          <div className="grid grid-cols-1 sm:grid-cols-2 pb-20 gap-5 bg-white">
            <div className="flex flex-col items-center sm:items-start ">
              <h1 className="text-center w-[90%] md:w-full sm:text-left text-lg font-bold underline ">
                Hi, My name is Olawumi Olusegun
              </h1>
              <h1 className="text-center w-[90%] md:w-full sm:text-left text-3xl md:text-4xl lg:text-6xl font-bold py-5 pt-2 ">
        ...
        <ContainerWrapper id="projects" className="pb-20">
          <h1 className="text-center text-3xl pb-20 font-semibold uppercase">
            Projects
          </h1>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-10 bg-white">
            ...
            <div className="flex flex-col gap-2  border rounded-md pb-2 ">
              ...
              <a
                href={"https://crm-dashboard-ryae.vercel.app"}
                target="_blank"
                className="self-end p-3"
              >
                <Button size={"sm"}>Live Demo</Button>
            ...
            <div className="flex flex-col gap-2  border rounded-md pb-2 ">
              ...
              <a
                href={"https://ai-prompt-eight-henna.vercel.app"}
                target="_blank"
                className="self-end p-3"
              >
                <Button size={"sm"}>Live Demo</Button>
            ...
            <div className="flex flex-col gap-2  border rounded-md pb-2 ">
              ...
              <a
                href={"https://capable-cannoli-3e5ebd.netlify.app"}
                target="_blank"
                className="self-end p-3"
              >
                <Button size={"sm"}>Live Demo</Button>
            ...
            <div className="flex flex-col gap-2  border rounded-md pb-2 ">
              ...
              <a
                href={"https://propertypulse-wine.vercel.app"}
                target="_blank"
                className="self-end p-3"
              >
                <Button size={"sm"}>Live Demo</Button>
            ...
            <div className="flex flex-col gap-2  border rounded-md pb-2 ">
              ...
              <a
                href={"https://tweet-chat.onrender.com/"}
                target="_blank"
                className="self-end p-3"
              >
                <Button size={"sm"}>Live Demo</Button>
            ...
            <div className="flex flex-col gap-2  border rounded-md pb-2 ">
              ...
              <a
                href={"https://saas-landing-page-jet.vercel.app"}
                target="_blank"
                className="self-end p-3"
              >
                <Button size={"sm"}>Live Demo</Button>
            ...
            <div className="flex flex-col gap-2  border rounded-md pb-2 ">
              ...
              <a
                href={"https://tiktalk-tawny.vercel.app"}
                target="_blank"
                className="self-end p-3"
              >
                <Button size={"sm"}>Live Demo</Button>
            ...
            <div className="flex flex-col gap-2  border rounded-md pb-2 ">
              ...
              <a
                href={"https://jobber-seven.vercel.app"}
                target="_blank"
                className="self-end p-3"
              >
                <Button size={"sm"}>Live Demo</Button>
        ...
        <div id="contact" className="w-full bg-gray-50 py-20 border-y ">
          <ContainerWrapper className="">
            ...
            <p className="text-center w-full lg:w-[80%] mx-auto my-8 font-normal text-gray-500 ">
              As a full-stack web developer, I am passionate about turning ideas
              into reality through innovative and efficient web solutions.
              Whether you need a stunning website, a dynamic web application, or
              custom development services, {"I'm"} here to help. {"Let's"}{" "}
              collaborate and make your project a success. Reach out today!
            </p>
              ...
              <div className="items-end">
                <div className="flex flex-col items-center justify-end gap-5 ml-auto">
                  ...
                  <a href="mailto: olawumi.olusegun@gmail.com">
                    <Button className="rounded-full bg-black hover:text-white text-white">
                      Send Message
                    </Button>
                  </a>
                </div>
              ...
              <div className="mt-5">
                <Form {...form}>
                  ...
                  >
                    ...
                    />
                    <Button
                      disabled={isSubmitting || isRequiredFieldEmpty}
                      type={isSubmitting ? "button" : "submit"}
                      className="w-full my-5 rounded-full disabled:cursor-not-allowed "
                    >
                      {isSubmitting && (
          ...
          <ContainerWrapper>
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-sm text-center font-semibold">
                &copy; {new Date().getFullYear()} Olawumi Olusegun.{" "}
              </p>
            </div>
          </ContainerWrapper>
        </div>
